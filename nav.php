<script>
        ...
        <nav class="navbar navbar-light navbar-vertical navbar-expand-xl" style="display: none;">
          ...
          <div class="d-flex align-items-center">
            ...
            <a class="navbar-brand" href="index-2.html">
              <div class="d-flex align-items-center py-3"><img class="me-2" src="assets/img/icons/spot-illustrations/mudahin.png" alt="" width="40" /><span class="font-sans-serif">mudahin</span></div>
            </a>
          </div>
              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  <div class="row navbar-vertical-label-wrapper mt-3 mb-2">
                      <div class="col-auto navbar-vertical-label">Sales dan Vendor</div>
                      <div class="col ps-0">
                  ...
                  <a href="#" class="nav-link">
                    <div class="d-flex align-items-center">
                      ...
                      <span class="nav-link-text ps-1">Feeds</span>
                    </div>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="#" class="nav-link">
                    <div class="d-flex align-items-center">
                      ...
                      <span class="nav-link-text ps-1">Affiliate Teams</span>
                    </div>
                  </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                  <div class="row navbar-vertical-label-wrapper mt-3 mb-2">
                      <div class="col-auto navbar-vertical-label">Transaksi</div>
                      <div class="col ps-0">
                          <hr class="mb-0 navbar-vertical-divider" />
                      </div>
                  </div>
                  <a class="nav-link dropdown-indicator" href="#order" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="order">
                      <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="far fa-clipboard"></span></span><span class="nav-link-text ps-1">Order / POS</span></div>
                  </a>
                  <ul class="nav collapse false" id="order">
                      <li class="nav-item">
                        <a class="nav-link" href="product-grid.php">
                          <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Semua</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="product-grid.php">
                          <div class="d-flex align-items-center"><span class="nav-link-text ps-1">POS</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="product-grid.php">
                          <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Barang Terjual</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="product-grid.php">
                          <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Order Baru</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="product-grid.php">
                          <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Siap Kirim</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="product-grid.php">
                          <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Di Proses</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="product-grid.php">
                          <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Barang Diterima</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="product-grid.php">
                          <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Batal</span></div>
                        </a><!-- more inner pages-->
                      </li>
                  </ul>
                </li>  
                <li class="nav-item">
                  <a href="#" class="nav-link">
                    <div class="d-flex align-items-center">
                      ...
                      <span class="nav-link-text ps-1">Keuangan</span>
                    </div>
                  </a>
                </li>              
                <li class="nav-item">
                    <div class="row navbar-vertical-label-wrapper mt-3 mb-2">
                        <div class="col-auto navbar-vertical-label">Produk</div>
                        <div class="col ps-0">
                            <hr class="mb-0 navbar-vertical-divider" />
                        </div>
                    </div>
                    <a class="nav-link dropdown-indicator" href="#product" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="product">
                        <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fas fa-shopping-cart"></span></span><span class="nav-link-text ps-1">Product</span></div>
                    </a>
                ...
                <li class="nav-item">
                  <a href="#" class="nav-link">
                    <div class="d-flex align-items-center">
                      ...
                      <span class="nav-link-text ps-1">Gudang</span>
                    </div>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="#" class="nav-link">
                    <div class="d-flex align-items-center">
                      ...
                      <span class="nav-link-text ps-1">Penyuplai</span>
                    </div>
                  </a>
                </li>
                ...
                <li class="nav-item">
                  <div class="row navbar-vertical-label-wrapper mt-3 mb-2">
                      <div class="col-auto navbar-vertical-label">Laporan</div>
                      <div class="col ps-0">
                          <hr class="mb-0 navbar-vertical-divider" />
                      </div>
                  </div>
                  <a href="#" class="nav-link">
                    <div class="d-flex align-items-center">
                      ...
                      <span class="nav-link-text ps-1">Jurnal</span>
                    </div>
                  </a>
                </li>   
        ...
        <nav class="navbar navbar-light navbar-glass navbar-top navbar-expand-xl" style="display: none;">
          ...
          <a class="navbar-brand me-1 me-sm-3" href="index-2.html">
            <div class="d-flex align-items-center"><img class="me-2" src="assets/img/icons/spot-illustrations/mudahin.png" alt="" width="40" /><span class="font-sans-serif">mudahin</span></div>
          </a>
                  ...
                  <div class="card navbar-card-components shadow-none dark__bg-1000">
                    <div class="card-body scrollbar max-h-dropdown"><img class="img-dropdown" src="assets/img/icons/spot-illustrations/authentication-corner.png" width="130" alt="" />
                      <div class="row">
                        ...
                        <div class="col-6 col-xxl-3">
                          <div class="nav flex-column mt-xxl-4 pt-xxl-1"><a class="nav-link py-1 link-600 fw-medium" href="modules/components/navs-and-tabs/top-navbar.html">Top navbar</a><a class="nav-link py-1 link-600 fw-medium" href="modules/components/navs-and-tabs/combo-navbar.html">Combo navbar</a><a class="nav-link py-1 link-600 fw-medium" href="modules/components/navs-and-tabs/tabs.html">Tabs</a><a class="nav-link py-1 link-600 fw-medium" href="modules/components/pictures/avatar.html">Avatar</a><a class="nav-link py-1 link-600 fw-medium" href="modules/components/pictures/images.html">Images</a><a class="nav-link py-1 link-600 fw-medium" href="modules/components/pictures/figures.html">Figures</a><a class="nav-link py-1 link-600 fw-medium" href="modules/components/pictures/hoverbox.html">Hoverbox</a><a class="nav-link py-1 link-600 fw-medium" href="modules/components/pictures/lightbox.html">Lightbox</a><a class="nav-link py-1 link-600 fw-medium" href="modules/components/progress-bar/basic.html">Basic progress bar</a><a class="nav-link py-1 link-600 fw-medium" href="modules/components/progress-bar/advance.html">Advance progress bar</a><a class="nav-link py-1 link-600 fw-medium" href="modules/components/pagination.html">Pagination</a></div>
                        </div>
                        <div class="col-6 col-xxl-3">
                          <div class="nav flex-column mt-xxl-4 pt-xxl-1"><a class="nav-link py-1 link-600 fw-medium" href="modules/components/popovers.html">Popovers</a><a class="nav-link py-1 link-600 fw-medium" href="modules/components/scrollspy.html">Scrollspy</a><a class="nav-link py-1 link-600 fw-medium" href="modules/components/search.html">Search</a><a class="nav-link py-1 link-600 fw-medium" href="modules/components/sidepanel.html">Sidepanel</a><a class="nav-link py-1 link-600 fw-medium" href="modules/components/spinners.html">Spinners</a><a class="nav-link py-1 link-600 fw-medium" href="modules/components/toasts.html">Toasts</a><a class="nav-link py-1 link-600 fw-medium" href="modules/components/tooltips.html">Tooltips</a><a class="nav-link py-1 link-600 fw-medium" href="modules/components/typed-text.html">Typed text</a><a class="nav-link py-1 link-600 fw-medium" href="modules/components/videos/embed.html">Embed</a><a class="nav-link py-1 link-600 fw-medium" href="modules/components/videos/plyr.html">Plyr</a></div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-6 col-xxl-3">
